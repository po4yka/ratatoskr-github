# GitHub Catalog documentation

- `ARCHITECTURE.md` — accounts, stars, lists, repository identity, watches, and backup policy.
- `REQUIREMENTS.md` — provider and product requirements.
- `DOMAIN.md` — catalog entities, modes, observations, and snapshots.
