...
1. Scaffold service, typed config, telemetry, errors, health, and schema.
...
Definition of Done: no false removals, credentials/scopes secure, rate limits respected, mutations audited/idempotent, migrations and workspace GitHub->Vault vertical slice pass. Deferred: broad issue/PR/discussion archival and organization administration.
